...
<button class="accordion">Does scanning the barcode of the library item with the app immediately trigger a checkout?</button>
...
<button class="accordion1">How many eBooks / eAudiobooks can I borrow?</button>
...
<button class="accordion1">How do I read the eBooks or listen to the eAudiobooks that I have borrowed?</button>
...
<button class="accordion1">How do I reserve eBooks / eAudiobooks? And can I cancel the reservation?</button>
...
<button class="accordion1">Do I need to install the Lynda mobile app?</button>
...
<button class="accordion1">What can I do with ‘My Points’ showing on my account page?</button>
